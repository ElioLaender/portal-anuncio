			...
			'<div class="ui-widget-content plupload_container">' +
				'<div class="ui-state-default ui-widget-header plupload_header">' +
					'<div class="plupload_header_content">' +
						...
						'<div class="plupload_header_title">' + _("Arquivos selecionados") + '</div>' +
						'<div class="plupload_header_text">' + _("Arraste as imagens para a caixa.") + '</div>' +
				...
				'<tr>' +
					'<td class="plupload_cell plupload_file_name">' + _('Nome') + '</td>' +
					'<td class="plupload_cell plupload_file_status">' + _('Status') + '</td>' +
					'<td class="plupload_cell plupload_file_size">' + _('Tamanho') + '</td>' +
					'<td class="plupload_cell plupload_file_action">&nbsp;</td>' +
				'</tr>' +
				'</table>' +

				'<div class="plupload_content">' +
					'<div class="plupload_droptext">' + _("Arraste arquivos aqui.") + '</div>' +
				...
				'<tr>' +
					'<td class="plupload_cell plupload_file_name">' +
						'<div class="plupload_buttons"><!-- Visible -->' +
							'<a class="plupload_button plupload_add">' + _("Selecionar Imagem") + '</a>&nbsp;' +
							'<a class="plupload_button plupload_start">' + _("Subir imagens.") + '</a>&nbsp;' +
	...
	*/
	...
	_handleState: function() {
		...
		if (up.total.queued === 0) {
			$('.ui-button-text', this.browse_button).html(_('Selecionar Imagens'));
		} else {
			$('.ui-button-text', this.browse_button).html(o.sprintf(_('%d Imagens'), up.total.queued));
		}
