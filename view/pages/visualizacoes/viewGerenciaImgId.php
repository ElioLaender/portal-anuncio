...
<base href="http://www.semprenegocio.com.br/" target="">
    ...
    <div class="tudo">
        ...
        <?php
            ...
            echo "<h2>O cadastro gratuito não possui inserção de Imagens.<br/> Imagens são muito importantes para divulgar o seu negócio e passar credibilidade!<br/>
                <a href='#'><h3>Quero fazer upgrade e sair na frente!</h3></a></h2>
                <br/>";
